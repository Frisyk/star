    ...
    return (
        <footer className="flex w-full items-center justify-between p-10 gap-3 lg:gap-10 text-sm lg:text-xl font-bold text-gray-600">
            ...
            <section className="flex  gap-5 lg:gap-8">
                <Link target='_blank' className="hover:text-red-700" href={'https://www.instagram.com/frisnadiyk/'} ><BsInstagram size={30} /> </Link>
                <Link target='_blank' className="hover:text-green-600" href={'https://wa.me/6285225505839'} ><BsWhatsapp size={30} /> </Link>
                <Link target='_blank' className="hover:text-gray-800" href={'https://github.com/frisyk'} ><BsGithub size={30} /> </Link>
